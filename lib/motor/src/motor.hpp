...
{
private:
    gpio_num_t in1, in2, pwmPin, encoderA, encoderB;
    int kp, ki, kd;
...
public:
    pcnt_unit_t encoder;
    motor(gpio_num_t in1, gpio_num_t in2, gpio_num_t pwmPin, gpio_num_t encoderA, gpio_num_t encoderB, ledc_channel_t pwmChannel, pcnt_unit_t pcntUnit);
